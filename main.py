...
# Make Dataset and Recognizers directory
try:
    files = ['dataset', 'recognizers']
...
def main_fun():
    ...
    def user_acc():
        ...
        challenge_bt = Button(account_fr, image=challenge_bt_img, bg='#182733', activebackground='#182733', bd=0, command=chall_checker)
